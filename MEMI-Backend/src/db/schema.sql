...
CREATE TABLE IF NOT EXISTS customers (
  ...
  -- Indirizzo di fatturazione (single default billing profile; business/tax fields)
  fatt_nome      VARCHAR(255) NULL,
  fatt_indirizzo VARCHAR(255) NULL,
  fatt_citta     VARCHAR(100) NULL,
  fatt_cap       VARCHAR(10)  NULL,
  fatt_provincia VARCHAR(4)   NULL,
  fatt_paese     VARCHAR(100) NULL DEFAULT 'Italia',
  fatt_piva      VARCHAR(20)  NULL,
  fatt_cf        VARCHAR(20)  NULL,
  fatt_sdi       VARCHAR(10)  NULL,
  fatt_pec       VARCHAR(255) NULL,
  wishlist      JSON,
  cart          JSON,
  sizes         JSON,
  preferences   JSON,
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  -- Billing snapshot (fatturazione). billing_same_as_shipping=1 → invoice uses shipping cols.
  billing_same_as_shipping TINYINT(1) NOT NULL DEFAULT 1,
  billing_nome       VARCHAR(255) NULL,
  billing_address    VARCHAR(255) NULL,
  billing_citta      VARCHAR(100) NULL,
  billing_cap        VARCHAR(10)  NULL,
  billing_provincia  VARCHAR(4)   NULL,
  billing_paese      VARCHAR(100) NULL,
  billing_piva       VARCHAR(20)  NULL,
  billing_cf         VARCHAR(20)  NULL,
  billing_sdi        VARCHAR(10)  NULL,
  billing_pec        VARCHAR(255) NULL,
